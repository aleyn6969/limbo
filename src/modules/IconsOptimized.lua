...
local IconModule = {
	...
	-- Bundle only the default Lucide pack. The previous executor path downloaded
	-- six icon packs sequentially on every load, blocking the first window for
	-- several seconds. Limbo uses Lucide throughout and still supports AddIcons
	-- for consumers that explicitly need another pack.
	Icons = {
		lucide = require("./LucideIcons"),
	},
}
